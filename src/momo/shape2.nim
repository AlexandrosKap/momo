...
template genGCirc2Con[T: SomeNumber](name: untyped) =
  ...
  func name*(x, y, radius: T): GCirc2[T] {.inline.} =
    GCirc2[T](position: gvec2[T](x, y), radius: radius)

  func name*(position: GVec2[T], radius: T): GCirc2[T] {.inline.} =
    GCirc2[T](position: position, radius: radius)

  func name*(): GCirc2[T] {.inline.} =
    GCirc2[T]()

template genGRect2Con[T: SomeNumber](name: untyped) =
  ## Generates rectangle constructors for a specific type.
  func name*(x, y, width, height: T): GRect2[T] {.inline.} =
    GRect2[T](position: gvec2[T](x, y), size: gvec2[T](width, height))

  func name*(position: GVec2[T], size: GVec2[T]): GRect2[T] {.inline.} =
    GRect2[T](position: position, size: size)

  func name*(): GRect2[T] {.inline.} =
    GRect2[T]()

template genGLine2Con[T: SomeNumber](name: untyped) =
  ## Generates line constructors for a specific type.
  func name*(x1, y1, x2, y2: T): GLine2[T] {.inline.} =
    GLine2[T](a: gvec2[T](x1, y1), b: gvec2[T](x2, y2))

  func name*(a: GVec2[T], b: GVec2[T]): GLine2[T] {.inline.} =
    GLine2[T](a: a, b: b)

  func name*(): GLine2[T] {.inline.} =
    GLine2[T]()

template genGPoly2Con[T: SomeNumber](name: untyped) =
  ## Generates polygon constructors for a specific type.
  func name*(x, y: T, points: varargs[GVec2[T]]): GPoly2[T] {.inline.} =
    GPoly2[T](position: gvec2[T](x, y), points: points.toSeq)

  func name*(position: GVec2[T], points: varargs[GVec2[T]]): GPoly2[T] {.inline.} =
    GPoly2[T](position: position, points: points.toSeq)

  func name*(): GPoly2[T] {.inline.} =
    GPoly2[T]()

template genOp(op: untyped) =
  ## Generates operator functions for every shape2 type.
  func op*[T: SomeNumber](a, b: GCirc2[T]): GCirc2[T] {.inline.} =
    GCirc2[T](
      position: op(a.position, b.position),
      radius: op(a.radius, b.radius)
    )

  func op*[T, V: SomeNumber](a: GCirc2[T], b: V): GCirc2[T] {.inline.} =
    GCirc2[T](position: op(a.position, b), radius: op(a.radius.V, b).T)

  func op*[T, V: SomeNumber](b: V, a: GCirc2[T]): GCirc2[T] {.inline.} =
    GCirc2[T](position: op(a.position, b), radius: op(a.radius.V, b).T)

  func op*[T: SomeNumber](a, b: GRect2[T]): GRect2[T] {.inline.} =
    GRect2[T](
      position: op(a.position, b.position),
      size: op(a.size, b.size)
    )

  func op*[T, V: SomeNumber](a: GRect2[T], b: V): GRect2[T] {.inline.} =
    GRect2[T](position: op(a.position, b), size: op(a.size, b))

  func op*[T, V: SomeNumber](b: V, a: GRect2[T]): GRect2[T] {.inline.} =
    GRect2[T](position: op(a.position, b), size: op(a.size, b))

  func op*[T: SomeNumber](a, b: GLine2[T]): GLine2[T] {.inline.} =
    GLine2[T](a: op(a.a, b.a), b: op(a.b, b.b))

  func op*[T, V: SomeNumber](a: GLine2[T], b: V): GLine2[T] {.inline.} =
    GLine2[T](a: op(a.a, b), b: op(a.b, b))

  func op*[T, V: SomeNumber](b: V, a: GLine2[T]): GLine2[T] {.inline.} =
    GLine2[T](a: op(a.a, b), b: op(a.b, b))

template genEqOp(op: untyped) =
  ## Generates equality operator functions for every shape2 type.
  func op*[T: SomeNumber](a: var GCirc2[T], b: GCirc2[T]) {.inline.} =
    op(a.position, b.position)
    op(a.radius, b.radius)

  func op*[T, V: SomeNumber](a: var GCirc2[T], b: V) {.inline.} =
    op(a.position, b)
    a.radius = op(a.radius.V, b).T

  func op*[T: SomeNumber](a: var GRect2[T], b: GRect2[T]) {.inline.} =
    op(a.position, b.position)
    op(a.size, b.size)

  func op*[T, V: SomeNumber](a: var GRect2[T], b: V) {.inline.} =
    op(a.position, b)
    op(a.size, b)

  func op*[T: SomeNumber](a: var GLine2[T], b: GLine2[T]) {.inline.} =
    op(a.a, b.a)
    op(a.b, b.b)

  func op*[T, V: SomeNumber](a: var GLine2[T], b: V) {.inline.} =
    op(a.a, b)
    op(a.b, b)

# Constructors and Operators

func gcirc2*[T: SomeNumber](x, y, radius: T): GCirc2[T] {.inline.} =
  GCirc2[T](position: gvec2[T](x, y), radius: radius)

func gcirc2*[T: SomeNumber](position: GVec2[T], radius: T): GCirc2[T] {.inline.} =
  GCirc2[T](position: position, radius: radius)

func gcirc2*[T: SomeNumber](): GCirc2[T] {.inline.} =
  GCirc2[T]()

func grect2*[T: SomeNumber](x, y, width, height: T): GRect2[T] {.inline.} =
  GRect2[T](position: gvec2[T](x, y), size: gvec2[T](width, height))

func grect2*[T: SomeNumber](position, size: GVec2[T]): GRect2[T] {.inline.} =
  GRect2[T](position: position, size: size)

func grect2*[T: SomeNumber](): GRect2[T] {.inline.} =
  GRect2[T]()

func gline2*[T: SomeNumber](x1, y1, x2, y2: T): GLine2[T] {.inline.} =
  GLine2[T](a: gvec2[T](x1, y1), b: gvec2[T](x2, y2))

func gline2*[T: SomeNumber](a, b: GVec2[T]): GLine2[T] {.inline.} =
  GLine2[T](a: a, b: b)

func gline2*[T: SomeNumber](): GLine2[T] {.inline.} =
  GLine2[T]()

func newGPoly2*[T](x, y: T, points: varargs[GVec2[T]]): GPoly2[T] {.inline.} =
  GPoly2[T](position: gvec2[T](x, y), points: points.toSeq)

func newGPoly2*[T](position: GVec2[T], points: varargs[GVec2[T]]): GPoly2[T] {.inline.} =
  GPoly2[T](position: position, points: points.toSeq)

func newGPoly2*[T](): GPoly2[T] {.inline.} =
  GPoly2[T]()
...
func `==`*[T: SomeNumber](a, b: GCirc2[T]): bool {.inline.} =
  a.position == b.position and a.radius == b.radius

func `==`*[T: SomeNumber](a, b: GRect2[T]): bool {.inline.} =
  a.position == b.position and a.size == b.size

func `==`*[T: SomeNumber](a, b: GLine2[T]): bool {.inline.} =
  a.a == b.a and a.b == b.b

func `==`*[T: SomeNumber](a, b: GPoly2[T]): bool {.inline.} =
